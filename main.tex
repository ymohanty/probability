...
\usepackage[unicode=true,
 ...
 {hyperref}
\hypersetup{pdftitle={Basic mathematics for statistics and economics},
...
\include{measurable_functions}

\include{integration}

\include{topology}

\include{spaces_of_functions}

\include{differentiation}

\include{product_measures}

\include{measure_and_topology}

\part{Probability}

\include{independence}

\include{fourier_transforms}

\include{conditioning}

\include{martingales}

\include{laws_of_large_numbers}

\include{central_limit_theorems}

\part{Statistics}

\include{point_estimation}

\include{hypothesis_testing}

\include{confidence_sets}\include{linear_models}

\include{design_experiments}

\appendix

\part{Appendices}

\include{naive_set_theory}

\include{finite_dimensional_vector_spaces}

\include{combinatorics}

\include{real_analysis}

\include{probability_distributions}
\end{document}
