...
change of variables theorem along with the fundamental theorem of calculus.
...
which is a geometric type analogue of compactness arguments from topology. Throughout, we shall be working in $\R^n$ where the standard notation $B_r\left(c\right)$ denotes a ball of radius $r$ 
